...
/**
 * Class ZadarmaPhoneCallChannel.
 * 
 * A notification channel to stablish a phone call through the Zadarma API.
 *
...
class ZadarmaPhoneCallChannel
{
    ...
    public function send($notifiable, Notification $notification)
    {
        ...
        $from = $notification->toZadarmaPhoneCall($notifiable);

        if (config('zadarma.is_channel_active') === true) {
            return $this->client->api()->requestCallback($from, $to);
        } else {
            return true;
        }
    }
